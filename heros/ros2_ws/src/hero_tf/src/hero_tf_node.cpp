...
HeroTfNode::HeroTfNode(): Node("hero_tf_node")
{
  //tf发布器创建
...
void HeroTfNode::publishDynamicTransform(const hero_msgs::msg::GimbalState & state)
{
...
void HeroTfNode::publishStaticTransforms()
{
