...
{
  EXPECT_EQ(sourceForMode(hero_msgs::msg::GimbalState::MODE_NORMAL), CommandSource::kNormal);
  EXPECT_EQ(sourceForMode(hero_msgs::msg::GimbalState::MODE_ANTI_TOP), CommandSource::kAntiTop);
  EXPECT_EQ(sourceForMode(hero_msgs::msg::GimbalState::MODE_AUTO_AIM), CommandSource::kAuto);
...
{
  EXPECT_TRUE(sourceMatchesMode(
    CommandSource::kNormal, hero_msgs::msg::GimbalState::MODE_NORMAL));
  EXPECT_FALSE(sourceMatchesMode(
    CommandSource::kNormal, hero_msgs::msg::GimbalState::MODE_ANTI_TOP));
  EXPECT_FALSE(sourceMatchesMode(CommandSource::kNone, hero_msgs::msg::GimbalState::MODE_NORMAL));
}
