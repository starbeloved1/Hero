...
private:
  ...
  static constexpr std::size_t kCandidateCount = 4U;
  ...
  hero_msgs::msg::ControlCommand makeSafeCommand(
  ...
  std::array<rclcpp::Subscription<hero_msgs::msg::ControlCommand>::SharedPtr, kCandidateCount>
    candidate_subs_;
